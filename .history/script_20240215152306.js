...
const getWeather = (city) => {
  ...
  fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=' + city, options)
    ...
    .then((response) => {
      ...
      const sunriseTime = new Date(response.sunrise * 1000); // Multiply by 1000 to convert seconds to milliseconds
      const sunsetTime = new Date(response.sunset * 1000);

      // Formatting the time (you can customize the format as needed)
