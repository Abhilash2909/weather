...
async function fetchWeatherData() {
  try {
    const response = await fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=' + city, options); // Replace 'YOUR_API_ENDPOINT' with the actual endpoint of your weather API
